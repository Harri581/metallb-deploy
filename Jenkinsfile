pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/harri581/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('harri581-225')   // <---- Change this to match your kubernetes cluster credentials
    }
